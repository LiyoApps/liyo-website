    ...
    <>
      <section className='hero'>
        <div className='container'>
          <div className='row'>
            <Heading subtitle='WELCOME TO LIYO-WEB-DEVELOPMENT-PLATFORM' title='Best Online Web Developer Expertise Are Here..' />
            ...
            <div className='button'>
              ...
              <button>
                VIEW PROJECTS <i className='fa fa-long-arrow-alt-right'></i>
              </button>
            </div>
          </div>
        </div>
